...
export interface EnvoyFilterSpec {
  ...
  /**
   * @schema EnvoyFilterSpec#filters
   */
  readonly filters?: EnvoyFilterSpecFilters[];

  /**
   * Deprecated.
   *
   * @schema EnvoyFilterSpec#workloadLabels
   */
  readonly workloadLabels?: { [key: string]: string };
...
/**
 * @schema EnvoyFilterSpecFilters
 */
export interface EnvoyFilterSpecFilters {
  /**
   * @schema EnvoyFilterSpecFilters#filterConfig
   */
   ...
   *
   * @schema EnvoyFilterSpecFilters#filterName
   */
   ...
   *
   * @schema EnvoyFilterSpecFilters#filterType
   */
  readonly filterType?: EnvoyFilterSpecFiltersFilterType;

  /**
   * Insert position in the filter chain.
   *
   * @schema EnvoyFilterSpecFilters#insertPosition
   */
  readonly insertPosition?: EnvoyFilterSpecFiltersInsertPosition;

  /**
   * @schema EnvoyFilterSpecFilters#listenerMatch
   */
  readonly listenerMatch?: EnvoyFilterSpecFiltersListenerMatch;
 ...
 * The type of filter to instantiate.
 *
 * @schema EnvoyFilterSpecFiltersFilterType
 */
export enum EnvoyFilterSpecFiltersFilterType {
  /** INVALID */
  INVALID = "INVALID",
  /** HTTP */
  HTTP = "HTTP",
 ...
 * Insert position in the filter chain.
 *
 * @schema EnvoyFilterSpecFiltersInsertPosition
 */
export interface EnvoyFilterSpecFiltersInsertPosition {
  /**
   * Position of this filter in the filter chain.
   *
   * @schema EnvoyFilterSpecFiltersInsertPosition#index
   */
  readonly index?: EnvoyFilterSpecFiltersInsertPositionIndex;

  /**
   * @schema EnvoyFilterSpecFiltersInsertPosition#relativeTo
   */
...
/**
 * @schema EnvoyFilterSpecFiltersListenerMatch
 */
export interface EnvoyFilterSpecFiltersListenerMatch {
  /**
   * One or more IP addresses to which the listener is bound.
   *
   * @schema EnvoyFilterSpecFiltersListenerMatch#address
   */
  readonly address?: string[];

  /**
   * Selects a class of listeners for the same protocol.
   *
   * @schema EnvoyFilterSpecFiltersListenerMatch#listenerProtocol
   */
  readonly listenerProtocol?: EnvoyFilterSpecFiltersListenerMatchListenerProtocol;

  /**
   * Inbound vs outbound sidecar listener or gateway listener.
   *
   * @schema EnvoyFilterSpecFiltersListenerMatch#listenerType
   */
  readonly listenerType?: EnvoyFilterSpecFiltersListenerMatchListenerType;

  /**
   * @schema EnvoyFilterSpecFiltersListenerMatch#portNamePrefix
   */
  readonly portNamePrefix?: string;

  /**
   * @schema EnvoyFilterSpecFiltersListenerMatch#portNumber
   */
 ...
 * Position of this filter in the filter chain.
 *
 * @schema EnvoyFilterSpecFiltersInsertPositionIndex
 */
export enum EnvoyFilterSpecFiltersInsertPositionIndex {
  /** FIRST */
  FIRST = "FIRST",
  /** LAST */
  LAST = "LAST",
 ...
 * Selects a class of listeners for the same protocol.
 *
 * @schema EnvoyFilterSpecFiltersListenerMatchListenerProtocol
 */
export enum EnvoyFilterSpecFiltersListenerMatchListenerProtocol {
  /** ALL */
  ALL = "ALL",
  /** HTTP */
  HTTP = "HTTP",
 ...
 * Inbound vs outbound sidecar listener or gateway listener.
 *
 * @schema EnvoyFilterSpecFiltersListenerMatchListenerType
 */
export enum EnvoyFilterSpecFiltersListenerMatchListenerType {
  /** ANY */
  ANY = "ANY",
  /** SIDECAR_INBOUND */
  SIDECAR_INBOUND = "SIDECAR_INBOUND",
